      ...
      public void paintComponent(Graphics g) {
        ...
        g.drawString("2P 점수 " + score1, 1700, 600);  
         ...
         for(int k = 0; k <= 83; k++) {
            ...
            g.drawImage(png4, k*size, 43*size, size, size, null);
            g.drawImage(png4, k*size, 42*size, size, size, null);
         }
         for(int l = 0; l <= 43; l++) {
            g.drawImage(png4, 0, l*size, size, size, null);
            g.drawImage(png4, size, l*size, size, size, null);
            g.drawImage(png4, 83*size, l*size, size, size, null);
            g.drawImage(png4, 82*size, l*size, size, size, null);
         }
